...
votes = Table('votes', pre_meta,
    ...
    Column('vote_resul', VARCHAR(length=20)),
)
...
def upgrade(migrate_engine):
    ...
    pre_meta.tables['votes'].columns['vote_resul'].drop()
    post_meta.tables['votes'].columns['vote_result'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    pre_meta.tables['votes'].columns['vote_resul'].create()
    post_meta.tables['votes'].columns['vote_result'].drop()
